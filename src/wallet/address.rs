...
pub const PQ_PUBKEY_LEN: usize = 2592;
pub const PQ_SIG_LEN: usize = 4627;

pub struct KeyPair {
    pub seed: [u8; 32],
    pub public: ml_dsa_87::PublicKey,
    pub secret: ml_dsa_87::PrivateKey,
    pub mnemonic: String,
}
...
impl KeyPair {
    ...
    pub fn from_mnemonic(phrase: &str) -> Result<Self> {
        ...
        let (public, secret) = ml_dsa_87::KG::keygen_from_seed(&seed);
